...
function Home2() {
    ...
    return (
        <motion.div
            style={bgStyle}
            className='p-4 md:p-20 flex flex-col justify-center items-center xl:mt-2'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
        >
            <div className='xl:mt-[-100px] ml-[-1300px]'>
                <img src="./Images/double-bg.png" alt="loading" className='h-24 w-24 md:h-28 md:w-28' />
            </div>
            <motion.div
                className="bg-[#3DB73E] opacity-90 rounded-xl rounded-br-none p-4 md:p-10"
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
                transition={{ duration: 0.5 }}
            >
